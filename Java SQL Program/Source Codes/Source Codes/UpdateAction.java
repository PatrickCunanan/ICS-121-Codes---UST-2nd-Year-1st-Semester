...
public class UpdateAction extends MainClass{
	
	/**
	 * @wbp.parser.entryPoint
	 */
	static String delpass = "pass";
	static void UpdateActionPerformed(ActionEvent a) throws Exception{
	    ...
	    JLabel lblSearchRecord = new JLabel("UPDATE RECORD");
	    springLayout.putConstraint(SpringLayout.WEST, lblSearchRecord, 0, SpringLayout.WEST, textField);
	...
	static javax.swing.JButton btnUpdate;
}
